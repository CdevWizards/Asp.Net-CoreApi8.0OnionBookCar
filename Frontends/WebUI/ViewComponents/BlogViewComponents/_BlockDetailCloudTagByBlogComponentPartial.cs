...
{
    public class _BlockDetailCloudTagByBlogComponentPartial:ViewComponent
    {
         private readonly IHttpClientFactory _httpClientFactory;

        public _BlockDetailCloudTagByBlogComponentPartial(IHttpClientFactory httpClientFactory)
        {
